...
namespace Proyecto_Inge_Bases_Web.Models
{
    ...
    public partial class TempPIEntities : DbContext
    {
        ...
        public virtual int spFisico_Insert(string nombre, string correoCliente, Nullable<double> precioEstimado, string condicion, string descripcion, byte[] productoImagen1, byte[] productoImagen2, byte[] productoImagen3, Nullable<bool> publicado, Nullable<System.DateTime> fechaRegistrado, string listaCategorias)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            var listaCategoriasParameter = listaCategorias != null ?
                new ObjectParameter("ListaCategorias", listaCategorias):
                new ObjectParameter("ListaCategorias", typeof(string));


            //Debug.WriteLine(listaCategorias);

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spFisico_Insert", nombreParameter, correoClienteParameter, precioEstimadoParameter, condicionParameter, descripcionParameter, productoImagen1Parameter, productoImagen2Parameter, productoImagen3Parameter, publicadoParameter, fechaRegistradoParameter, listaCategoriasParameter);
        }
        ...
        public virtual int spVirtual_Insert(string nombre, string correoCliente, Nullable<double> precioEstimado, string condicion, string descripcion, byte[] productoImagen1, byte[] productoImagen2, byte[] productoImagen3, Nullable<bool> publicado, Nullable<System.DateTime> fechaRegistrado, string tipoDeArchivo, string derechosDeProducto, string fuentes, Nullable<System.DateTime> fechaExpiracion, string listaCategorias)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
        ...
        public virtual int spFisico_Update(Nullable<int> productoID, string correoCliente, string listaCategorias)
        {
            var productoIDParameter = productoID.HasValue ?
                new ObjectParameter("ProductoID", productoID) :
                new ObjectParameter("ProductoID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spFisico_Update", productoIDParameter, correoClienteParameter, listaCategoriasParameter);
        }
    
        public virtual int spVirtual_Update(Nullable<int> productoID, string correoCliente, string tipoDeArchivo, string derechosDeProducto, string fuentes, Nullable<System.DateTime> fechaExpiracion, string listaCategorias)
        {
            var productoIDParameter = productoID.HasValue ?
                new ObjectParameter("ProductoID", productoID) :
                new ObjectParameter("ProductoID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spVirtual_Update", productoIDParameter, correoClienteParameter, tipoDeArchivoParameter, derechosDeProductoParameter, fuentesParameter, fechaExpiracionParameter, listaCategoriasParameter);
        }
